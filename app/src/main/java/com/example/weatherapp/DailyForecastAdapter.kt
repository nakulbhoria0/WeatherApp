...
private val tempDisplaySettingManager: TempDisplaySettingManager): RecyclerView.ViewHolder(view){
    ...
    private val tempText = view.findViewById<TextView>(R.id.tempTextView)
    private val descriptionText = view.findViewById<TextView>(R.id.descriptionTextView)
...
): ListAdapter<DailyForecast, DailyForecastViewHolder>(DIFF_UTIL) {

    companion object{
        val DIFF_UTIL = object: DiffUtil.ItemCallback<DailyForecast>() {
